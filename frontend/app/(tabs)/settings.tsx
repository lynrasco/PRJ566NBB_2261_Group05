...
import { getAllItems, clearAuthToken } from "@/services/api";
      ...
      >
        ...
        >
          ...
          <Text style={[styles.meta, isDark && styles.metaDark]}>
            @{profile.username} ·{" "}
            {t("valuedItemsCount", { count: items.length })}
          </Text>
        </View>
            ...
            return (
              <Pressable
                ...
                style={({ pressed }) => [
                  ...
                  pressed &&
                    (isDark ? styles.rowPressedDark : styles.rowPressed),
                ]}
              >
        ...
        <Pressable
          ...
          style={({ pressed }) => [
            ...
            pressed &&
              (isDark ? styles.signOutPressedDark : styles.signOutPressed),
          ]}
        >
