...
export default {
  ...
  deleteSuccessItem: "Article supprimé avec succès.",
  cancel: "Annuler",
  delete: "Supprimer",
  ...
  security: "Sécurité",
  securityDesc: "Gérez votre mot de passe et les paramètres de sécurité de votre appareil.",
  ...
  privacyDesc: "Gérez la façon dont FlipValue utilise votre profil, votre historique d'articles et votre activité dans l'application.",
  privTitleFeature: "Partager les données d'analyse",
  privSubtitleFeature: "Aidez à améliorer FlipValue en partageant des données d'utilisation de base.",
  ...
  themeSystemDesc: "Utilisation des paramètres d'apparence de votre appareil.",
  themeUsing: "Utilisation du mode {{mode}}.",
  themeUsingLight: "Utilisation du mode clair.",
  themeUsingDark: "Utilisation du mode sombre.",
  themeLightDesc: "Utiliser une interface lumineuse.",
  themeDarkDesc: "Utiliser une interface sombre.",
  themeSystemOptionDesc: "Suivre les paramètres de votre appareil.",

  // About Us Screen:
  aboutUs: "À propos de nous",
  ourMission: "Notre mission",
  ourMissionDesc: "FlipValue aide les revendeurs et les amateurs de friperies à prendre de meilleures décisions de prix en identifiant les détails des articles et en les comparant à des annonces similaires.",
  whatWeDo: "Ce que nous faisons",
  featureRecognize: "Identifier les marques, les styles et les matériaux.",
  featurePricing: "Suggérer des fourchettes de prix de revente équitables.",
  featureListings: "Aider à créer de meilleures annonces et à éviter les erreurs de prix.",
  projectTeam: "Équipe du projet",
  createdBy: "par iSALAJ Inc",
